...
type
  TfrmPedidosAddVigas = class(TfrmBaseConexao)
    ...
    procedure btn_exc_vigaClick(Sender: TObject);
...
begin
  ...
  begin
    ...
    try
      ...
      if frmPedidosDigitarVigas.p_confirmado  then
      begin
        mtb_vigas.Insert;
...
procedure TfrmPedidosAddVigas.btn_exc_vigaClick(Sender: TObject);
begin
  inherited;
  if not mtb_vigas.IsEmpty then mtb_vigas.Delete;
end;
...
procedure TfrmPedidosAddVigas.btn_simClick(Sender: TObject);
begin
  inherited;
  prc_salvar;
end;
...
procedure TfrmPedidosAddVigas.FormClose(Sender: TObject;
...
procedure TfrmPedidosAddVigas.FormCreate(Sender: TObject);
begin
  inherited;
  p_confirmado := false;
end;
...
begin
  ...
  try
    ...
    loqry.Open;
    eixo_laje := loqry.FieldByName('EIXO_LAJE').AsInteger /1000;
...
procedure TfrmPedidosAddVigas.prc_totalizar_reforcos;
var
 ferro_4, ferro_5, ferro_6, ferro_8, ferro_10, ferro_12: double;
begin
 ferro_4  := 0;
 ferro_5  := 0;
 ferro_6  := 0;
 ...
 ferro_12 := 0;
  ...
  begin
    {verifica se tem ferro de 4,2}
    if mtb_vigasField4_2.AsInteger > 0 then
    begin
      ferro_4 := ferro_4 + ( mtb_vigasqtde.AsInteger * mtb_vigasField4_2.AsInteger * ( mtb_vigastamanho.AsFloat + mtb_vigasdobra_ini.AsFloat+ mtb_vigasdobra_fim.AsFloat ));
      mtb_ferragens.First;
      if mtb_ferragens.Locate('DIAMETRO',4,[]) then
      begin
        mtb_ferragens.Edit;
        mtb_ferragensqtde_total.AsFloat := ferro_4;
        mtb_ferragens.post;
      end;
    end;

    {verifica se tem ferro de 5,0}
    if mtb_vigasField5_0.AsInteger > 0 then
    begin
      ferro_5 := ferro_5 + ( mtb_vigasqtde.AsInteger * mtb_vigasField5_0.AsInteger * ( mtb_vigastamanho.AsFloat + mtb_vigasdobra_ini.AsFloat+ mtb_vigasdobra_fim.AsFloat ));
      mtb_ferragens.First;
      if mtb_ferragens.Locate('DIAMETRO',5,[]) then
      begin
        mtb_ferragens.Edit;
        mtb_ferragensqtde_total.AsFloat := ferro_5;
        mtb_ferragens.post;
      end;
    end;

    {verifica se tem ferro de 6,3}
    if mtb_vigasField5_0.AsInteger > 0 then
    begin
      ferro_6 := ferro_6 + ( mtb_vigasqtde.AsInteger * mtb_vigasField6_3.AsInteger * ( mtb_vigastamanho.AsFloat + mtb_vigasdobra_ini.AsFloat+ mtb_vigasdobra_fim.AsFloat ));
      mtb_ferragens.First;
      if mtb_ferragens.Locate('DIAMETRO',6,[]) then
      begin
        mtb_ferragens.Edit;
        mtb_ferragensqtde_total.AsFloat := ferro_6;
        mtb_ferragens.post;
      end;
    end;

    {verifica se tem ferro de 8,0}
    if mtb_vigasField5_0.AsInteger > 0 then
    begin
      ferro_8 := ferro_8 + ( mtb_vigasqtde.AsInteger * mtb_vigasField8_0.AsInteger * ( mtb_vigastamanho.AsFloat + mtb_vigasdobra_ini.AsFloat+ mtb_vigasdobra_fim.AsFloat ));
      mtb_ferragens.First;
      if mtb_ferragens.Locate('DIAMETRO',8,[]) then
      begin
        mtb_ferragens.Edit;
        mtb_ferragensqtde_total.AsFloat := ferro_8;
        mtb_ferragens.post;
      end;
    end;

    {verifica se tem ferro de 10,0}
    if mtb_vigasField10_0.AsInteger > 0 then
    begin
      ferro_10 := ferro_10 + ( mtb_vigasqtde.AsInteger * mtb_vigasField10_0.AsInteger * ( mtb_vigastamanho.AsFloat + mtb_vigasdobra_ini.AsFloat+ mtb_vigasdobra_fim.AsFloat ));
      mtb_ferragens.First;
      if mtb_ferragens.Locate('DIAMETRO',10,[]) then
      begin
        mtb_ferragens.Edit;
        mtb_ferragensqtde_total.AsFloat := ferro_10;
        mtb_ferragens.post;
      end;
    end;

    {verifica se tem ferro de 12,5}
    if mtb_vigasField12_5.AsInteger > 0 then
    begin
      ferro_12 := ferro_12 + ( mtb_vigasqtde.AsInteger * mtb_vigasField12_5.AsInteger * ( mtb_vigastamanho.AsFloat + mtb_vigasdobra_ini.AsFloat+ mtb_vigasdobra_fim.AsFloat ));
      mtb_ferragens.First;
      if mtb_ferragens.Locate('DIAMETRO',12,[]) then
      begin
        mtb_ferragens.Edit;
        mtb_ferragensqtde_total.AsFloat := ferro_12;
        mtb_ferragens.post;
      end;
    end;
...
procedure TfrmPedidosAddVigas.prc_salvar;
begin
  if fnc_validar then
  begin
    p_confirmado := true;

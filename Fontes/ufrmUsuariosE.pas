  ...
  try
    ...
    try
      ...
      begin
        ...
        Add('SELECT * FROM ' + Self.Tabela + ' WHERE PESSOA_ID =:ID');
      ...
      begin
        CriarMensagem('AVISO','usuário não encontrado!');
...
begin
  ...
  try
    ...
    on E : Exception do
       ...
       CriarMensagem('AVISO','Erro na prc_salvar');
...
begin
  ...
  try
    ...
    on E : Exception do
       Raise Exception.Create(E.Message + Self.Name +'.Incluir Usuário');
    end;
end;
...
begin
  ...
  begin
    CriarMensagem('AVISO','Informe um LOGIN');
    edt_login.SetFocus;
    exit;
  end;
  ...
  begin
    CriarMensagem('AVISO','Informe uma senha');
    edt_senha.SetFocus;
    exit;
  end;

  //***
  CriarMensagem('AVISO','Usuário validado com sucesso!');
...
begin
  case Self.Operacao of
    ...
    begin
      ...
      if CriarMensagem('CONFIRMACAO','Deseja continuar incluindo?' ) then
          prc_inicializar
        else
          ModalResult := mrOk;
      end
      ...
      begin
        CriarMensagem('AVISO','Não foi possível incluir o usuário');
      end;
    end;
    ...
    begin
      ...
      if CriarMensagem('DELETE','Deseja excluir este registro?' ) then
      ...
      begin
        ...
        begin
          CriarMensagem('AVISO','Não foi possível excluir o usuário');
        end;
      end; // if
    end;
  end;// case

  ...
  begin
    try
      ...
      *)
      ...
      loQry.Close;
      loqry.SQL.Clear;
      loQry.sql.Add('select * from PRODUTOS_EPS where ALTURA =:ALTURA and LARGURA =:LARGURA and COMPRIMENTO =:COMPRIMENTO');

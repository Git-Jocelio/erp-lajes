...
type
  TfrmCartaoTaxas = class(TfrmBaseGrade)
    ...
    qryDESCRICAO_OPERADORA: TStringField;
    qryDESCRICAO_BANDEIRA: TStringField;
...
procedure TfrmCartaoTaxas.btnLocalizarClick(Sender: TObject);
begin
  inherited;
...
begin
  ...
  qry.SQL.Add('  p.nome as descricao_operadora,      ');
  qry.SQL.Add('  b.descricao as descricao_bandeira,  ');
  qry.SQL.Add('  t.ativo                             ');
  qry.SQL.Add('from                                  ');
  qry.SQL.Add('  cartao_taxas t,                     ');
  qry.SQL.Add('  cartao_operadoras o,                ');
  qry.SQL.Add('  cartao_bandeiras b,                 ');
  qry.SQL.Add('  pessoas p                           ');
  qry.SQL.Add('where                                 ');
  qry.SQL.Add('  p.id = o.pessoa_id and              ');
  qry.SQL.Add('  t.cartao_operadoras_id = o.pessoa_id and   ');

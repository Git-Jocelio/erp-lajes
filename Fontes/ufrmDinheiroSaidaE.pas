...
//ShowMessage('incluir');
  ...
  if ( cb_contas_receber.Checked ) and ( cbx_pessoas.KeyValue > 0 )then
  begin
    ufinanceiro.AddContasReceber(conexao,-1,date, cbx_pessoas.KeyValue, 'DINHEIRO_SAIDA',
    codigo,1,1,strtofloatdef(edt_valor.Text,0),0,0,0,0,date,0,0, edt_historico.text,'',cbx_contas.KeyValue );
  end;

...
procedure prc_alterar(ACodigo, APedidoId, AVendedorId: integer;ADescricao: string;
                      AQuantidade, APrecoVendedor, APrecoVenda: double);
  ...
  try
    ...
    try
      ...
      begin
        ...
        SQL.Clear;
        Add('Select                                     ');
        Add(' SUM( (quantidade * CUSTO_VEND) ) as CUSTO,');

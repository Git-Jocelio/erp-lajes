inherited frmPesquisaContas: TfrmPesquisaContas
  BorderStyle = bsNone
  Caption = 'frmPesquisaContas'
  ClientHeight = 527
  ClientWidth = 939
  OnShow = FormShow
  ExplicitWidth = 939
  ...
  object Panel1: TPanel [0]
    ...
    object Label2: TLabel
      ...
      Width = 357
      Height = 17
      Caption = 'Segure o tecla Ctrl e click no registros que deseja selecionar '
  ...
  object pnl_cabecalho: TPanel [1]
    ...
    object lbl_titulo: TLabel
      ...
      Margins.Bottom = 0
      Align = alLeft
      Caption = 'CONSULTA DE CONTAS A PAGAR / RECEBER'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 8404992
      Font.Height = -21
      Font.Name = 'Segoe UI Semibold'
  ...
  object Panel2: TPanel [2]
    ...
    object rg_tipo_documento: TRadioGroup
      Left = 555
      Top = 3
      Width = 283
      Height = 80
      ...
      Items.Strings = (
        ...
        'Todos')
      TabOrder = 0
      OnClick = rg_tipo_documentoClick
    end
  ...
  object pnl_dbgrid: TPanel [3]
    ...
    object dbg_registros: TDBGrid
      ...
      Font.Name = 'Segoe UI'
      Font.Style = []
      Options = [dgTitles, dgTabs, dgRowSelect, dgMultiSelect, dgTitleClick, dgTitleHotTrack]
      ParentFont = False
      TabOrder = 0
    ...
    object pnl_resultado: TPanel
      ...
      object lbl_resultado: TLabel
        ...
        Margins.Bottom = 0
        Align = alLeft
        Caption = 'Lista de contas a pagar a pessoa'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 15395562
        Font.Height = -21
        Font.Name = 'Segoe UI Semibold'
  ...
  object mtb_contas: TFDMemTable
    ...
    Left = 48
    Top = 305
    object mtb_contasID: TIntegerField
      FieldName = 'ID'
    end
    object mtb_contasNR_DOCUMENTO: TStringField
      FieldName = 'NR_DOCUMENTO'
    end
    object mtb_contasDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
    object mtb_contasTOTAL_PARCELA: TFloatField
      FieldName = 'TOTAL_PARCELA'
      DisplayFormat = '0.00'
    end
    object mtb_contasVALOR_PAGO: TFloatField
      FieldName = 'VALOR_PAGO'
      DisplayFormat = '0.00'
    end
    object mtb_contasBAIXAR: TFloatField
      FieldName = 'BAIXAR'
      DisplayFormat = '0.00'
    end
    object mtb_contasTABELA_ORIGEM: TStringField
      FieldName = 'TABELA_ORIGEM'
      Size = 40
    end
  end
  object mtb_contas_selecionadas: TFDMemTable
    FieldDefs = <>
    IndexDefs = <>
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ...
    Left = 800
    Top = 273
    object mtb_contas_selecionadasID: TIntegerField
      DisplayWidth = 10
      FieldName = 'ID'
    end
    object mtb_contas_selecionadasNR_DOCUMENTO: TStringField
      DisplayWidth = 15
      FieldName = 'NR_DOCUMENTO'
      Size = 10
    end
    object mtb_contas_selecionadasDESCRICAO: TStringField
      DisplayWidth = 36
      FieldName = 'DESCRICAO'
      Size = 100
    end
    object mtb_contas_selecionadasTOTAL_PARCELA: TFloatField
      DisplayWidth = 20
      FieldName = 'TOTAL_PARCELA'
    end
    object mtb_contas_selecionadasVALOR_PAGO: TFloatField
      DisplayWidth = 12
      FieldName = 'VALOR_PAGO'
    end
    object mtb_contas_selecionadasBAIXAR: TFloatField
      DisplayWidth = 10
      FieldName = 'BAIXAR'
    end
    object mtb_contas_selecionadasTABELA_ORIGEM: TStringField
      FieldName = 'TABELA_ORIGEM'
      Size = 40
    end
  end
  object DataSource1: TDataSource
    DataSet = mtb_contas_selecionadas
    Left = 800
    Top = 249
  end
end

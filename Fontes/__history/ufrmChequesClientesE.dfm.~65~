inherited frmChequesClientesE: TfrmChequesClientesE
  Left = 349
  Top = 89
  BorderStyle = bsNone
  BorderWidth = 3
  ...
  inherited pnTitulo: TPanel
    ...
    inherited lbl_titulo: TLabel
      Width = 520
      Height = 40
      Caption = 'CADASTRO DE CHEQUE DE CLIENTE'
      ExplicitWidth = 340
    end
      ...
      object tbs_pesquisa: TTabSheet
        ...
        object pnl_pesquisa: TPanel
          ...
          object Label3: TLabel
            ...
            Width = 337
            Height = 17
            Caption = 'Informe um CPF ou CNPJ (digite pelo menos 4 caracteres)'
          end
          object Label18: TLabel
            ...
            Width = 295
            Height = 17
            Caption = 'Contas bancarias cadastradas para esse CPF/CNPJ'
          end
          object edt_cpf_cnpj: TEdit
            ...
            ParentFont = False
            TabOrder = 0
            OnChange = edt_cpf_cnpjChange
          end
          object btn_novo_correntista: TBitBtn
            Left = 13
            Top = 320
            Width = 196
            Height = 25
            Caption = 'Cadastrar novo correntista'
            TabOrder = 1
            OnClick = btn_novo_correntistaClick
          end
          object btn_alterar_dados: TBitBtn
            Left = 213
            Top = 320
            Width = 196
            Height = 25
            Caption = 'Alterar dados correntista'
            Enabled = False
            TabOrder = 2
            OnClick = btn_alterar_dadosClick
          end
      ...
      object tbs_cadastro: TTabSheet
        ...
        object GroupBox2: TGroupBox
          ...
          object Label14: TLabel
            ...
            Width = 209
            Height = 17
            Caption = 'Hist'#243'rico(Respons'#225'vel pelo cheque)'
          end
          ...
          object edt_nr_cheque: TEdit
            ...
            NumbersOnly = True
            TabOrder = 3
            OnExit = edt_nr_chequeExit
          end
          object dtp_data_cheque: TDateTimePicker
            Left = 467
            Top = 41
            Width = 105
            Height = 25
            Date = 45806.000000000000000000
            Time = 0.676293449076183600
            TabOrder = 4
          end
          object edt_histórico: TEdit
            Left = 124
            Top = 97
            Width = 448
            Height = 25
          ...
          object GroupBox3: TGroupBox
            ...
            object cb_repassado: TCheckBox
              ...
              TabOrder = 0
              OnClick = cb_repassadoClick
            end
            object pnl_id_conta: TPanel
              Left = 520
              Top = 21
              Width = 50
              Height = 25
            ...
            object dtp_repassado: TDateTimePicker
              Left = 152
              Top = 20
              Width = 108
              Height = 25
              Date = 45866.000000000000000000
              Time = 0.609419837965106100
              TabOrder = 2
            end
            object edt_repassado: TEdit
              Left = 360
              Top = 20
              Width = 210
              Height = 25
            ...
            object cb_devolvido: TCheckBox
              ...
              TabOrder = 4
              OnClick = cb_devolvidoClick
            end
            object dtp_devolvido: TDateTimePicker
              Left = 152
              Top = 56
              Width = 108
              Height = 25
            ...
            object cbx_receber: TDBLookupComboBox
              Left = 360
              Top = 56
              Width = 210
              Height = 25
  ...
  object qry_contas: TFDQuery
    SQL.Strings = (
      ...
      '   cc.nr_conta'
      'from'
      '  correntista_contas cc,'
      '  pessoas p1,'
      '  bancos b,'
      '  pessoas p2'
      'where'
      '  p1.id = cc.pessoa_id and'
      '/*  cc.banco_id = b.id and */'
      '  cc.banco_id = b.pessoa_id and '
      '  p2.id = b.pessoa_id and'
      '  p1.cpf_cnpj like :cpf_cnpj')
    Left = 424
    Top = 129
    ParamData = <
      item
  ...
  object qry_devedor: TFDQuery
    SQL.Strings = (
      'select id, nome from pessoas order by nome')
    Left = 414
    Top = 420
  end
  object ds_devedor: TDataSource
    AutoEdit = False
    DataSet = qry_devedor
    Left = 414
    Top = 388

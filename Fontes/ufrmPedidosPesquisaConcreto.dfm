inherited frmPedidosPesquisaConcreto: TfrmPedidosPesquisaConcreto
  BorderStyle = bsNone
  Caption = 'frmPedidosPesquisaConcreto'
  ClientHeight = 275
  ClientWidth = 522
  ExplicitWidth = 522
  ExplicitHeight = 275
  ...
  object pnl_fundo: TPanel [0]
    ...
    object cbx_produto: TDBLookupComboBox
      Left = 15
      Top = 115
      Width = 490
      Height = 25
    ...
    object edt_unitario: TEdit
      ...
      OnKeyPress = edt_unitarioKeyPress
    end
  ...
  inherited qry: TFDQuery
    ...
    SQL.Strings = (
      'select '
      '  p.id, p.descricao, p.unidade, p.preco_custo '
      'from'
      '  produtos p, produtos_concreto c '

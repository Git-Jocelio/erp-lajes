...
begin
 ...
 //ShowMessage('aguardando ' + floattostr(pedido_aguardando));
    ...
    begin
      ...
      {lançamento a partir do form consulta estqoues, entrada ou saida de na
      quantidade pra corrigir o estoque}
      ...
      {lançamento a partir do form ComprasE, entrada na
      quantidade do estoque}
      if situacao_pedido = 'COMPRA' then
      begin
        estoque_fisico     := estoque_fisico + quantidade;
        estoque_disponivel := estoque_fisico - pedido_aberto;
        estoque_liquido    := estoque_disponivel - pedido_aguardando;

...
uses
  ...
  ufrmComissoesItensE, ufrmPedidosE;
...
begin
  ...
  ufrmPedidosE.Alterar(pedido_id);

  btnLocalizar.Click;

  qry.First;
  qry.Locate('PEDIDO_ID', pedido_id,[]);
...
begin
  ...
  DBGrid1.Enabled := not qry.IsEmpty;

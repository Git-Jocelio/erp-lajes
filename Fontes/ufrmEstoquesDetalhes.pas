...
begin
  ...
  qry_itens_pedidos.SQL.Add('select  ');
  qry_itens_pedidos.SQL.Add('  it.pedido_id, ');
  qry_itens_pedidos.SQL.Add('  it.produto_Id,  ');
  qry_itens_pedidos.SQL.Add('  prod.nome_fantasia,                     ');
  qry_itens_pedidos.SQL.Add('  it.qtde                                 ');
  ...
  qry_itens_pedidos.SQL.Add('prod.viga = ' + quotedstr('S') + ' and ');
  qry_itens_pedidos.SQL.Add('it.pedido_id = :pedido_id');

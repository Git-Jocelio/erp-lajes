inherited frmPesquisaChequeCliente: TfrmPesquisaChequeCliente
  BorderStyle = bsNone
  BorderWidth = 3
  Caption = 'frmPesquisaChequeCliente'
  ClientHeight = 327
  ClientWidth = 876
  ExplicitWidth = 882
  ExplicitHeight = 333
  ...
  inherited pnTitulo: TPanel
    ...
    inherited lbl_titulo: TLabel
      Width = 354
      Caption = 'CHEQUES DE CLIENTES EM CARTEIRA'
      ExplicitWidth = 354
    end
    inherited lbl_sub_titulo: TLabel
      Width = 233
      Caption = 'Lista de cheques de clientes em carteira'
      ExplicitWidth = 233
    end
  ...
  inherited qry: TFDQuery
    ...
    SQL.Strings = (
      ...
      '  b.PESSOA_ID = p2.ID and'
      '  cc.repassado =:REPASSADO')
    Left = 120
    Top = 168
    ParamData = <
      item
    ...
    object qryCORRENTISTA_ID: TIntegerField
      FieldName = 'CORRENTISTA_ID'
      Origin = 'CORRENTISTA_ID'
      Required = True
    end
  end

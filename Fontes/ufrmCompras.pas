...
uses
  ...
  Vcl.DBCtrls, Vcl.ToolWin, Vcl.StdCtrls, Vcl.Buttons, frxClass, frxDBSet,
...
begin
   ...
   begin
     qry.SQL.ADD(' and ABERTO_ENTREGUE <>:ABERTO_ENTREGUE ');
     qry.ParamByName('ABERTO_ENTREGUE').AsString := '';
   end;
...
procedure TfrmCompras.actImprimirExecute(Sender: TObject);
begin
  inherited;
  frx_rel_compras.ShowReport;
end;

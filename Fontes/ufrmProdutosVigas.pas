...
begin
  ...
  TRY
    ...
    if rgForma.ItemIndex = 0 then qryAux2.FieldByName('FORMA_MEDIDA'  ).AsInteger := 130 else
    if rgForma.ItemIndex = 1 then qryAux2.FieldByName('FORMA_MEDIDA'  ).AsInteger := 250 else
    if rgForma.ItemIndex = 2 then qryAux2.FieldByName('FORMA_MEDIDA'  ).AsInteger := 120;

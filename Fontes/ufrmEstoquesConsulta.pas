...
type
  TfrmEstoquesConsulta = class(TfrmBaseConexao)
    ...
    procedure btn_imprimir_pesquisaClick(Sender: TObject);
...
begin
  ...
  qry_composicao.Connection := conexao;
  tbs_composicao.TabVisible := false;
...
begin
  ...
  begin
    ...
    tbs_composicao.TabVisible := true;
  end;
  // lajotas
...
procedure TfrmEstoquesConsulta.tbs_composicaoShow(Sender: TObject);
var
  loqry : TFDquery ;
begin
  {lista o movimento do produto}
  qry_composicao.Close;
  qry_composicao.ParamByName('PRODUTO_ID').AsInteger := qry.FieldByName('ID').AsInteger;
  qry_composicao.Open;
...
procedure TfrmEstoquesConsulta.btn_imprimir_pesquisaClick(Sender: TObject);
begin
  inherited;
...
begin
  ...
  begin
    ...
    btn_imprimir_pesquisa.Enabled := not qry.IsEmpty;

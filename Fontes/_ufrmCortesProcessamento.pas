...
type
  TfrmCortesProcessamento = class(TForm)
    ...
    procedure ds_impressaoDataChange(Sender: TObject; Field: TField);
...
begin
  ...
  // cortes com sobra
  if not mtb_corte_resto.IsEmpty then
  begin
...
procedure TfrmCortesProcessamento.btn_imprimirClick(Sender: TObject);
begin
  frxReport.ShowReport;
end;

procedure TfrmCortesProcessamento.ds_impressaoDataChange(Sender: TObject;
  Field: TField);
begin
  btn_imprimir.Enabled := not mtb_impressao.IsEmpty;
end;

inherited frmTransportadoras: TfrmTransportadoras
  Caption = 'frmTransportadoras'
  TextHeight = 15
  ...
  inherited pnl_cabecalho: TPanel
    inherited lbl_titulo: TLabel
      Width = 342
      Height = 56
      Caption = 'CONSULTA DE TRANSPORTADORAS'
      ExplicitWidth = 342
    end
  end
  ...
  inherited qry: TFDQuery
    ...
    SQL.Strings = (
      'select '
      '  T.ID, P.CPF_CNPJ, P.NOME, P.TELEFONE, P.CELULAR, P.ATIVO  '
      'from TRANSPORTADORAS T, PESSOAS P where P.ID = T.PESSOA_ID ')
    Top = 24

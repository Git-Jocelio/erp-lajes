...
type
  TfrmCorrentistasContas = class(TfrmBaseEdicao)
    ...
    procedure btn_novo_bancoClick(Sender: TObject);
  ...
  public
    ...
    property p_nome_banco :string read Fp_nome_banco write Fp_nome_banco;
...
//  p_banco_id   := qry.FieldByName('id').AsInteger;
  p_banco_id   := qry.FieldByName('pessoa_id').AsInteger;
  p_banco      := edt_cod_banco.Text;
  p_nome_banco := cbx_bancos.Text;
...
procedure TfrmCorrentistasContas.btn_novo_bancoClick(Sender: TObject);
begin
  ufrmBancosE.prc_incluir;
  ubiblioteca.AtualizaQuery(qry);
end;

procedure TfrmCorrentistasContas.cbx_bancosCloseUp(Sender: TObject);
begin
  inherited;
 // p_nome_banco := cbx_bancos.Text;
end;

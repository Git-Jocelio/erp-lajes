...
begin
  ...
  BEGIN
    ...
    img_icone.Picture.LoadFromFile( ExtractFilePath ( Application.ExeName ) + '\ICONES\aviso.png' );
  ...
  BEGIN
    ...
    img_icone.Picture.LoadFromFile( ExtractFilePath ( Application.ExeName ) + '\ICONES\delete.png' );
  ...
  BEGIN
    ...
    btn_nao.Visible    := TRUE;
    btn_sim.caption    := 'SIM ( ENTER )';
    img_icone.Picture.LoadFromFile( ExtractFilePath ( Application.ExeName ) + '\ICONES\confirmacao.png' );
  ...
  BEGIN
    ...
    btn_sim.caption    := 'OK ( ENTER )';
    img_icone.Picture.LoadFromFile( ExtractFilePath ( Application.ExeName ) + '\ICONES\erro.png' );

...
begin
  ...
  begin
    qry.sql.clear;
    qry.SQL.Add('insert into ' + Tabela      ); //CORRENTISTAS
    qry.SQL.Add('(                          ');
...
begin
  ...
  try
    ...
    loQry.sql.Add('select c.id, c.banco_id, p.nome, b.cod_BANCO, c.nr_agencia, c.nr_conta from correntista_contas c, bancos b, pessoas p where c.pessoa_id =:pessoa_id and c.banco_id = b.pessoa_id and p.id = b.pessoa_id');

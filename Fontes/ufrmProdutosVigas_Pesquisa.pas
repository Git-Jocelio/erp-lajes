...
begin
 ...
 StatusBar.Panels[0].Text :='';
  ...
  if localizar then
   StatusBar.Panels[0].Text := 'Foram localizadas "' + inttostr(qry.RecordCount) + '" Vigas'
  else
   ShowMessage('Vigas não cadastrada no sistema');

end;

function TfrmProdutosVigas_Pesquisa.localizar: boolean;
var
  loAltura: integer;
begin
...
procedure TfrmProdutosVigas_Pesquisa.componentes;
begin

...
begin
  ...
  uTipos.opIncluir: begin
                       pnTitulo.Caption := 'CADASTRO DE CONCRETO USINADO';
                       ...
                       qry.FieldByName('CONCRETO').AsString           := 'S';

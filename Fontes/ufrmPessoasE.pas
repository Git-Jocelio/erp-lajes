...
begin
  ...
  uTipos.opIncluir: begin
                       pnTitulo.Caption       := 'CADASTRO DE PESSOAS';
...
//       Raise Exception.Create(E.Message +  slinebreak +' NÃO FOI POSSIVEL SALVAR O REGISTRO! ' );
    ...
    begin
      ...
      try
        ...
        conexao.Rollback;
        criarMensagem('AVISO','Não foi possível alterar o registro');
      end;
    end;
    ...
    begin
      ...
      begin
        ...
        try
          ...
          conexao.Rollback;
          criarMensagem('AVISO','Não foi possível excluir o registro');
        end;
      end; // if
    end;
  end;// case
...
begin
  ...
  begin
    criarMensagem('AVISO','Selecione o tipo de Pessoa');
    rg_pessoa.SetFocus;
    exit;
  ...
  *)
  ...
  begin
    ...
    begin
      criarMensagem('AVISO','Informe um Cpf / Cnpj válido ou deixe o campo em branco');
      edt_cpf_cnpj.SetFocus;
      exit;
    end;
    ...
    begin
      try
        try
          ...
          begin
            criarMensagem('AVISO','Cpf/Cnpj : ' + trim(loQuery.fieldbyname('CPF_CNPJ').AsString) + ' já está cadastrado no sistema');
            exit;
          end;
        finally
          FreeAndNil(loQuery);
  ...
  begin
   // lajes triunfo qry.FieldByName('CPF_CNPJ').AsString :='00000000000';
    ...
    criarMensagem('AVISO','Informe um documento válido');
    edt_cpf_cnpj.SetFocus;
    exit
  ...
  begin
    criarMensagem('AVISO','Informe pelo menos um telefone');
    exit;
  end;

  if edt_nome.Text = '' then
  begin
    criarMensagem('AVISO','Informe o nome do cliente');
  ...
  begin
    criarMensagem('AVISO','Informe o endereço');
  ...
  begin
    criarMensagem('AVISO','Informe o número do endereço');
  ...
  begin
    criarMensagem('AVISO','Informe o bairro do endereço');
  ...
  begin
    criarMensagem('AVISO','Informe a cidade do endereço');
  ...
  if edt_uf.Text = '' then
  begin
    criarMensagem('AVISO','Informe a UF do endereço');
